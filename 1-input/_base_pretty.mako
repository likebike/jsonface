...
<!--[if !IE]><!--> <html class="no-js not-ie" lang=en> <!--<![endif]-->
  ...
  <body>
    ...
    <section id=header>
      <a id=logo href="<%block name="LOGO_URL">${pyhpy.url('/index.html', mtime=None)}</%block>"><%block name="LOGO_NAME"><div class=name>jsonface</div></%block>
      <%block name="LOGO_SLOGAN"><div id=slogan>Unmarshal JSON Data into Go Interfaces</div></%block>
      <%block name="LOGO_IMAGE"><div class="asciiLogo vcompressed"><%text>
              "JSON!"
  _        _     \  _
=(.)__   <(.)__   >(.)__
 (___/    (___/    (___/
